...
\section{Rozwój szkieletów aplikacji dla WWW}
	...
	\subsection{Historia i rozwój}
		...
		\begin{code}
			...
			\caption[Przykład użycia tagów JSP]{\textit{header.jsp} - plik JSP definiujący nagłówek \textbf{wizard} wykorzystujący język znaczników do tworzenia dynamicznej treści\\źródło: opracowanie własne}.
		\end{code}
		...
		za logikę biznesową oraz warstwę widoku\cite{art_of_java_web_dev}.
	 	\begin{code}
			...
			\caption[Przykład wymieszania logiki biznesowej oraz warstwy widoku w pliku JSP]{Przykład wymieszania logiki biznesowej oraz warstwy widoku w pliku JSP\\źródło: opracowanie własne}.

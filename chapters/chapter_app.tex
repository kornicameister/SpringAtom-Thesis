...
\section{Opis aplikacji wspomagającej warsztat samochodowy}
	...
	\subsubsection{Organizator spotkań}
		...
		spotkania dostarczającej znacznie więcej informacji niż sam organizator oraz uruchomienie
		...
		\subsubsection{Model - Warstwa repozytoriów}
			...
			\begin{code}
				\inputminted[
					...
					samepage=true,
					fontsize=\scriptsize
				]{java}{../SpringAtom/src/main/java/org/agatom/springatom/server/repository/repositories/car/SCarMasterRepository.java}
				% src file used
			...
			\begin{code}
				\inputminted[
					...
					samepage=true,
					fontsize=\scriptsize
				]{java}{../SpringAtom/src/main/java/org/agatom/springatom/server/repository/SRepository.java}
				% src file used
				\label{app:scarmaster_repo}
			...
			\begin{code}
				\inputminted[
					...
					samepage=true,
					fontsize=\scriptsize
				]{java}{../SpringAtom/src/main/java/org/agatom/springatom/server/repository/factory/SRepositoriesFactoryBean.java}
				% src file used
				\label{app:scarmaster_repo}
		...
		\subsubsection{Model - Warstwa serwisów}
			...
			\begin{code}
				\inputminted[
					...
					samepage=true,
					fontsize=\scriptsize
				]{java}{../SpringAtom/src/main/java/org/agatom/springatom/server/service/domain/SPersonService.java}
				% src file used
		...
		\subsubsection{Widok - Warstwa widoku}
			...
			\begin{code}
				\inputminted[
					...
					samepage=true,
					fontsize=\scriptsize
				]{xml}{../SpringAtom/src/main/webapp/ui/core/core-page-view.xml}
				% src file used
			...
			\begin{code}
				\inputminted[
					...
					samepage=true,
					fontsize=\scriptsize
				]{jsp}{../SpringAtom/src/main/webapp/ui/core/page.jsp}
				% src file used
		...
		\subsubsection{Widok - Warstwa komponentów}
			...
			\begin{code}
				\inputminted[
					...
					samepage=true,
					fontsize=\scriptsize
				]{java}{../SpringAtom/src/main/java/org/agatom/springatom/web/component/builders/ComponentBuilder.java}
				% src file used
			...
			\begin{code}
				\inputminted[
					...
					samepage=true,
					fontsize=\scriptsize
				]{java}{../SpringAtom/src/main/java/org/agatom/springatom/web/rbuilder/table/ReportTableBuilder.java}
				% src file used
				\label{app:handleDynamicColumn}
				\caption[Uzyskania wartości dynamiczego atrybutu]{
					Uzyskania wartości dynamiczego atrybutu w momencie tworzenia
		...
		\subsubsection{Globalna - Warstwa konwersji}
			...
			\begin{code}
				\inputminted[
					...
					samepage=false,
					fontsize=\scriptsize
				]{java}{../SpringAtom/src/main/java/org/agatom/springatom/server/model/conversion/picker/PersistableConverterPicker.java}
				% src file used
